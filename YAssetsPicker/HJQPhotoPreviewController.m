...
- (void)setModel:(HImageModel *)model {
    ...
    [[HJQImageManager manager] getPhotoWithAsset:model.assets completion:^(UIImage *photo, NSDictionary *info, BOOL isDegraded) {
...
@interface HJQPhotoPreviewController ()<UICollectionViewDataSource,UICollectionViewDelegate,UIScrollViewDelegate> {
...
@implementation HJQPhotoPreviewController
...
- (void)select:(UIButton *)selectButton {
    ...
    HJQAssetsViewController *assetVC =(HJQAssetsViewController *)self.handleViewControlelr;
...
//- (void)showPhotoBytes {
//    
//    [[HJQImageManager manager] getPhotosBytesWithArray:@[_photoArr[_currentIndex]] completion:^(NSString *totalBytes) {
