...
{
    [[HJQImageManager manager] getAllAlbumscompletion:^(NSArray<YAlbumModel *> *models) {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [[HJQImageManager manager] getPostImageWithAlbumModel:model completion:^(UIImage *postImage) {
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    HJQAssetsViewController *assetsVC = [[HJQAssetsViewController alloc] initWithNav:self.navController];
...
- (void)pushToAssetsController
{
    ...
    if ([[HJQImageManager manager] authorizationStatusAuthorized]) {
        HJQAssetsViewController *assetsVC = [[HJQAssetsViewController alloc] initWithNav:self.navController];
        if (self.groupAlbums.count) {
